...
def send_whatsapp_message(message, destination_number):
    ...
    headers = {
        ...
        'apikey': 'q67ybibvftgeir1me6apoz7xsymopnuq'
    }
...
services = {
    "finchat": {
        ...
        "icon": "https://finchat.finovateglobal.com/assets/images/icons/finchat.png",
    ...
    "kyc": {
        "id": 2,
        "title": "KYC Connect",
        "icon": "https://finchat.finovateglobal.com/assets/images/icons/kyc.png",
    ...
    "coop-pulse": {
        "id": 3,
        "title": "Co-op Pulse",
        "icon": "https://finchat.finovateglobal.com/assets/images/icons/coop-pulse.png",
    ...
    "customer-support": {
        ...
        "icon": "https://finchat.finovateglobal.com/assets/images/icons/customer-support.png",
    ...
    "notify": {
        "id": 5,
        "title": "Notify",
        "icon": "https://finchat.finovateglobal.com/assets/images/icons/notify.png",
